...
class EventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get index and return events in the correct order" do
    event_names = %i[future_conference rails_world_2023 tropical_rb_2024 wnb_rb_meetup railsconf_2017 rubyconfth_2022 brightonruby_2024 no_sponsors_event].map { |event| events(event) }.map(&:name)
