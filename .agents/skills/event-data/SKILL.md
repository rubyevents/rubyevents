...
**Always use the generators of MCP tools if possible.**
...
If you create a CFP, capture a screenshot from http://localhost:3000/events/<event-slug>/cfps after the changes are seeded.
