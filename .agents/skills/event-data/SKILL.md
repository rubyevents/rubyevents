...
6. Take a screenshot with playwright of any pages that were affected by the update, and include the screenshots in your PR description using the gh-image extension for GH.
