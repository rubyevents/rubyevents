...
module User::TypesenseSearchable
  ...
  class_methods do
    ...
    def typesense_search_speakers(query, options = {})
      query_by_fields = "name,bio,alias_names,github_handle,twitter,topic_names,event_names,recent_talk_titles"

      search_options = {
        query_by_weights: "10,3,8,5,5,4,3,2",
  ...
  def should_index?
    canonical_id.nil? && talks_count > 0 && !marked_for_deletion?
  end
end
