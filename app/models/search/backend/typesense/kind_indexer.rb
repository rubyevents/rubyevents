...
class Search::Backend::Typesense
  class KindIndexer
    ...
    TALK_KINDS = {
      ...
      "open_mic" => {name: "Open Mics", icon: "microphone", category: "talk"},
      "announcement" => {name: "Announcements", icon: "bullhorn", category: "talk"},
      "city_pitch" => {name: "City Pitches", icon: "city", category: "talk"},
