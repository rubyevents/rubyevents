...
module Event::TypesenseSearchable
  ...
  included do
    ...
    typesense enqueue: :trigger_typesense_job, if: :should_index? do
      ...
      multi_way_synonyms [
        {"conference-synonym" => %w[conference conf]},
        {"meetup-synonym" => %w[meetup meet-up usergroup user-group]},
  ...
  class_methods do
    ...
    def typesense_search_events(query, options = {})
      query_by_fields = "name,description,series_name,alias_names,keynote_speaker_names,topic_names,city,country_name"

      search_options = {
        query_by_weights: "10,3,8,5,4,3,2,2",
