...
module Talk::TypesenseSearchable
  ...
  class_methods do
    ...
    def typesense_search_talks(query, options = {})
      query_by_fields = "title,summary,description,speaker_names,speaker_github_handles,speaker_twitter_handles,event_name,series_name,topic_names,resource_names,transcript_text"

      search_options = {
        query_by_weights: "10,5,3,8,9,9,4,4,6,7,1",
  ...
  def should_index?
    video_provider.in?(Talk::WATCHABLE_PROVIDERS) && !external_player?
  end
end
